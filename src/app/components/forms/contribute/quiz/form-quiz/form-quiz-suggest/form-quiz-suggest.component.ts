...
@Component({
  selector: 'app-form-quiz-suggest',
  templateUrl: './form-quiz-suggest.component.html',
  styleUrls: ['./form-quiz-suggest.component.css']
})
export class FormQuizSuggestComponent implements OnInit {
  ...
  constructor(
    ...
    this.model.title = "Quizz Suggestion";
    this.suggestionsCategories = this.contributeService.getSuggestCategoriesBySlug("quiz");
