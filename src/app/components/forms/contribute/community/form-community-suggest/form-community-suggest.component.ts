...
@Component({
  selector: 'app-form-community-suggest',
  templateUrl: './form-community-suggest.component.html',
  styleUrls: ['./form-community-suggest.component.css']
})
export class FormCommunitySuggestComponent implements OnInit {
  ...
  constructor(
    ...
    this.model.title = "Commun'UT Suggestion";
    this.suggestionsCategories = this.contributeService.getSuggestCategoriesBySlug("community");
  ...
  prepareEmail(): Promise<void> {
    let promise: Promise<void> = new Promise<void>((resolve, reject) => {
      this.authenticationService.getCurrentUser().subscribe((user) => {
        ...
        this.email.subject = "[Commun'UT][Suggestion] Suggestion d'amélioration de Commun'UT";
